...
# Load static prompts from prompts folder
PROMPT_SINGLE_ANALYSIS = load_prompt("single_analysis.md")


## Load dual analysis prompt from prompts folder
PROMPT_DUAL_ANALYSIS = load_prompt("dual_analysis.md")
